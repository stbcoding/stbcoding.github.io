...
$(tableDescription.selector+'_edit_dialog').parent().removeClass('overlayed2');wpDataTablesUpdatingFlags[tableDescription.tableId]=!1};wpDataTablesFunctions[tableDescription.tableId].applyData=function(data){$(data).each(function(index,el){if(el){var val=el.toString()}else{var val=''}
...
function wdtAddOverlay(table_selector){jQuery(table_selector).addClass('overlayed2')}
function wdtRemoveOverlay(table_selector){jQuery(table_selector).removeClass('overlayed2')}
